...
const getAllProductos = async (req, res) => {
  try {
    ...
    const validOrderFields = ['id', 'nombre', 'precio', 'activo', 'oferta', 'descuento', 'imagenUrl', 'fechaActualizacion', 'idCategoria', 'descripcion', 'especificaciones'];
    ...
    const { count, rows: products } = await Producto.findAndCountAll({
      ...
      limit: limit,
      offset: offset,
      attributes: ['id', 'nombre', 'precio', 'activo', 'oferta', 'descuento', 'imagenUrl', 'fechaActualizacion', 'idCategoria', 'descripcion', 'especificaciones']
    });
