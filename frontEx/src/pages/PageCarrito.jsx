...
import { mensajeCompra } from "../mocks/emailText/textEmail";
...
const PageCarrito = () => {
  ...
  const comprarAndVaciarCarrito = async () => {
    const confirmar = await swalServiceConfirmed(
      ...
      "Recibirás un email con la confirmación y el estado de tu compra!",
      "success",
      "Vaciar carrito",
      "Cancelar"
    );
    ...
    const emailData = {
      ...
      subject: "✅ ¡Confirmación de Compra - VitalCrossfit!",
      text: mensajeCompra(customerInfo.name),
    };
    sendEmail(emailData)
