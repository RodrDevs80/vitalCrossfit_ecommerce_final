...
export default function CartProduct({
  ...
  // Función para formatear precios en pesos argentinos con el formato específico
          ...
          {cuponValido && id === cupon.idProducto ? (
            <>
              <span className="text-gray-400">
                <strike>{formatearPrecioArgentino(precio)}</strike>
              </span>
